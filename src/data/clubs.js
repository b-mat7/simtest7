...
const clubsData = [
  {
    ...
    'initials': "FRB",
    'colorPrim': null,
    'initiative': 1.29,   // 1 bis 1.5  -> seed calc x2
    'attack': 2.15,
    'shoot': 2.27,
    'defend': 2.75,
    'save': 3.11,
    ...
    'seed': function () { return           parseFloat((this.attack + this.shoot + this.defend + this.save + (this.initiative * 2)).toFixed(2))},
    ...
    'playMomAverage': function () { return this.matchesPlayed     > 0 ? parseFloat((this.playMomSum / this.intervalsPlayed).toFixed(2)) : 0 },
    'initiativeStrAverage': function () { return this.matchesPlayed > 0 ? parseFloat((this.initiativeStrSum / this.intervalsPlayed).toFixed(2)) : 0 },
    ...
    'initiativeStrDiceAverage': function () { return this.matchesPlayed > 0 ? parseFloat((this.initiativeStrAverage() - (this.playMomAverage() * this.initiative * 1.3)).toFixed(2)) : 0 },
