...
const clubsData = [
  {
    ...
    'shotStrDiceAverage': function () { return this.matchesPlayed   > 0 ? parseFloat((this.shotStrAverage() - (this.shoot)).toFixed(2)) : 0 },
    'saveStrDiceAverage': function () { return this.matchesPlayed   > 0 ? parseFloat((this.saveStrAverage() - (this.save)).toFixed(2)) : 0 },
