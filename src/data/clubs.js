...
const clubsData = [
  {
    ...
    'initiativeStrDiceAverage': function () { return this.matchesPlayed > 0 ? parseFloat((this.initiativeStrAverage() - (this.initiative * this.momentumAverage() * 1.3)).toFixed(2)) : 0 },
