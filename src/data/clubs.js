...
const clubsData = [
  {
    ...
    'playsDiff': function () { return                                   this.attPlays - this.defPlays },
  ...
  },
  {
    ...
    'shotStrDiceAverage': function () {return this.matchesPlayed > 0    ? parseFloat((this.shotStrAverage() - (this.shoot * this.buffAverage())).toFixed(2)) : 0 },
    // andere 3 fertig
    // rename attPlay -> attacks
    // APStrSum... raus, dafür APAverage APDiceAverage in DisplayClub + Table + Match?
    // number formating: simMatch displayClub displayTable club...
    // DisplayClub etwas schmaler
